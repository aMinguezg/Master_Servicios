 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://webservices.ejemplo1.ws/", wsdlLocation = "http://localhost:8080/WS_Ejemplo1/soapws/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://webservices.ejemplo1.ws/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_Ejemplo1/soapws/calculator?wsdl");
    ...
    public ICalculator getCalculatorPort() {
        return super.getPort(new QName("http://webservices.ejemplo1.ws/", "CalculatorPort"), ICalculator.class);
    }
    ...
    public ICalculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.ejemplo1.ws/", "CalculatorPort"), ICalculator.class, features);
    }
